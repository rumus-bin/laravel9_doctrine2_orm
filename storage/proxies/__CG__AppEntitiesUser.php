...
class User extends \App\Entities\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'email', 'emailVerifiedAt', 'password', 'rememberToken', 'createdAt', 'updatedAt', 'posts'];
        }
     ...
     * {@inheritDoc}
     */
    public function setEmailVerifiedAt(\Illuminate\Support\Carbon $emailVerifiedAt): void
    {
    ...
    public function setRememberToken(string $rememberToken): void
    {
        ...
        parent::setRememberToken($rememberToken);
    }
     ...
     * {@inheritDoc}
     */
    public function setCreatedAt(\Illuminate\Support\Carbon $createdAt): void
    {
     ...
     * {@inheritDoc}
     */
    public function setUpdatedAt(\Illuminate\Support\Carbon $updatedAt): void
    {
     ...
     * {@inheritDoc}
     */
    public function addPost(\App\Entities\Blog\Post $post): \App\Entities\User
    {
